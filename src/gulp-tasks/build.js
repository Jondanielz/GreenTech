...
function CopyAssetsToTheme() {
  ...
  let copyEntry = gulp.src("./src/index.html").pipe(gulp.dest("../dist/"));
  let copyPages = gulp.src("./views/**/*").pipe(gulp.dest("../dist/views"));
...
gulp.task("replacePaths", () => {
  let replacePath1 = gulp
    .src(["./src/index.html"], { base: "../dist" })
    .pipe(replace('="../../assets', '="assets'))
    .pipe(gulp.dest("../dist"));
  let replacePath2 = gulp
    .src(["./views/**/*.html"], { base: "../dist" })
    .pipe(replace('="../../../../assets', '="../../assets'))
    .pipe(gulp.dest("../dist"));
